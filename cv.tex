...
Principal Applied Scientist at \href{https://aws.amazon.com}{Amazon Web Services}\\
...
\bibitem{P10} ``Systems and methods for automatically generating solver code for nonlinear model predictive control solvers''.
...
\bibitem{P9} ``Wearable exoskeleton''.
...
\bibitem{P8} ``Actively adapting to driving environments based on human interactions''.
Soonho Kong, Jonathan DeCastro, Nikos Arechiga, and Frank Permenter
United States Patent \#11801852. October 2023.

\bibitem{P7}``Certified control for self-driving cars''.
